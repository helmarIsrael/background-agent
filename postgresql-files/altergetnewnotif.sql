-- FUNCTION: public.getnotification(text[], text, text)

-- DROP FUNCTION IF EXISTS public.getnotification(text[], text, text);
...
ALTER FUNCTION public.getnotification(text[], text, text)
    OWNER TO admin;
